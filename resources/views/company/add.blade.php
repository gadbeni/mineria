                        ...
                        <div class="panel panel-bordered">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        <small>Código Operador Minero <em class="text-muted">(auto-generado)</em></small>
                                        <input type="text" id="codeMiningOperator" class="form-control text bg-light" readonly placeholder="Se genera al guardar...">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-addon" id="btn-verpassword"><span class="fa fa-eye"></span></span>
                                        </div>
                                    </div> 
                                </div>
                            </div>
